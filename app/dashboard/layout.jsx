        ...
        <header className="md:hidden bg-blue-600 text-white px-4 pt-4 pb-6 flex-shrink-0 relative overflow-hidden"
          ...
          <div className="absolute inset-0 pointer-events-none">
            <svg width="100%" height="100%" viewBox="0 0 390 130" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M-10,80 C40,40 90,110 150,70 C210,30 260,90 320,55 C360,35 385,60 400,50 L400,130 L-10,130 Z" fill="rgba(255,255,255,0.06)"/>
              <path d="M-10,95 C30,65 80,105 140,82 C200,58 250,100 310,78 C350,64 380,82 400,75 L400,130 L-10,130 Z" fill="rgba(255,255,255,0.08)"/>
              <path d="M-10,108 C50,88 100,118 160,100 C220,82 270,112 330,95 C365,84 385,98 400,93 L400,130 L-10,130 Z" fill="rgba(255,255,255,0.10)"/>
